...
summary: 'An events platform connecting hosts and vendors. Built with Next.js, Chakra UI, AWS Amplify (later migrated to Supabase), and Stripe for payments. Overcame AWS Amplify’s limitations by integrating additional AWS services. The result is a scalable, fast, and user-friendly platform with seamless payments.'
---
